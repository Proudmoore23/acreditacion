...
class DOCENTE(models.Model):
    ...
    DOC_CELU = models.IntegerField('Celular',unique=True)
    DOC_EMAIL = models.CharField('Email',max_length=50,unique=True)
    DOC_NOMBRE = models.CharField('Nombre',max_length=50)
    DOC_APE_PATER = models.CharField('Apellido Paterno',max_length=50,default="",editable=True)
    DOC_APE_MATER = models.CharField('Apellido Materno',max_length=50,default="",editable=True)
    ...
    def __str__(self):
        return self.DOC_NOMBRE + " " +  self.DOC_APE_PATER+" "+self.DOC_APE_MATER 
...
class CURSO(models.Model):
    ...
    CUR_NOMBRE = models.CharField('Asignatura',max_length=60)
...
class experienciaLABORAL(models.Model):
    ...
    EXL_FECHA_FIN = models.DateField('Fecha de Fin')
...
class experienciaDOCENTE(models.Model):
    ...
    EXD_FECHA_FIN = models.DateField('Fecha de Fin')
...
class grupoInvestigacion(models.Model):
    ...
    GI_FECHA_FIN = models.DateField('Fecha de Fin')

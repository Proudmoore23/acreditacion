...
class DocenteForm(forms.ModelForm):
	class Meta:
		...
		widgets ={
			...
			"DOC_CELU" :  forms.NumberInput(attrs={'class': 'form-control'}),
			...
			"DOC_APE_PATER" :  forms.TextInput(attrs={'class': 'form-control'}),
			"DOC_APE_MATER" :  forms.TextInput(attrs={'class': 'form-control'}),
			"DOC_SEXO" : forms.Select(attrs={'class': 'form-control'},choices=[('M', 'MASCULINO'), ('F', 'FEMENINO')]),
			"DOC_NAC" : DateInput(attrs={'class': 'form-control'}),  
				#forms.DateInput(attrs={'class': 'form-control'}),
			"DOC_ESTADO" :  forms.Select(attrs={'class': 'form-control'},choices=[('ACTIVO', 'ACTIVO'), ('INACTIVO', 'INACTIVO'),('SUSPENDIDO', 'SUSPENDIDO'),('OBSERVADO', 'OBSERVADO')])
		}
...
class expLaboralForm(forms.ModelForm):
	class Meta:
		...
		widgets = {
			...
			"EXL_FECHA_INI": DateInput(),
			    #forms.DateInput(attrs={'class':'form-control'}),
			"EXL_FECHA_FIN": DateInput(),
			    #forms.DateInput(attrs={'class':'form-control'}),
...
class expDocenteForm(forms.ModelForm):
	class Meta:
		...
		widgets = {
			"EXD_FECHA_INI" :  DateInput(),
			    #forms.DateInput(attrs={'class':'form-control'}),
			"EXD_FECHA_FIN": DateInput(),
			    #forms.DateInput(attrs={'class':'form-control'}),
...
class GroupForm(forms.ModelForm):
	class Meta:
		...
		widgets = {
			...
			"GI_FECHA_INI": DateInput(),
			    #forms.DateInput(attrs={'class':'form-control'}),
			"GI_FECHA_FIN": DateInput(),
			    #forms.DateInput(attrs={'class': 'form-control'}),
...
class EspecForm(forms.ModelForm):
	class Meta:
		...
		widgets = {
			...
			"ESP_FECHA_INI": DateInput(),
			    #forms.DateInput(attrs={'class':'form-control'}),
			"ESP_FECHA_FIN": DateInput(),
			    #forms.DateInput(attrs={'class': 'form-control'}),
			"docente": forms.Select(attrs={'class': 'form-control'}),
			"institucion": forms.Select(attrs={'class': 'form-control'}),
		}
